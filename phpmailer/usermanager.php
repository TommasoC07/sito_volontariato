...
try {
    ...
    $user = $stmt->fetch(PDO::FETCH_ASSOC);
    echo "<div class='alert alert-danger alert-dismissible fade show'> Utente eliminato correttamente\n <button type='button' class='btn-close' data-bs-dismiss='alert'></button> </div>";
}catch(PDOException $e) {
...
try{
    ...
    $user = $stmt->fetch(PDO::FETCH_ASSOC);
    echo "<div class='alert alert-warning alert-dismissible fade show'> Utente aggiornato correttamente\n <button type='button' class='btn-close' data-bs-dismiss='alert'></button> </div>";
}catch(PDOException $e) {
